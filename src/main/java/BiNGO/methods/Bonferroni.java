...
public class Bonferroni implements CalculateCorrectionTask {
     ...
     */
    private static final Logger LOGGER = Logger.getLogger(Bonferroni.class);
    ...
    public void calculate() {
        ...
        for (int i = 0; i < m; i++) {
            ...
            if (mp.compareTo(min) < 0) adjustedPvalues[i] = mp.toString();
            else adjustedPvalues[i] = min.toString();
        }
