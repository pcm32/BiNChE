...
public class HypergeometricDistribution {
    ...
    /**
     * method that conducts the calculations. P(x or more |X,N,n) = 1 - sum{[C(n,i)*C(N-n, X-i)] / C(N,X)} for i=0 ...
     * x-1
     * 
     * @return double result for the distr.
     */
    ...
    public String calculateHypergDistr() {
        return calcHypergDistr().toString();
    }
}
