...
import BiNGO.methods.binomial.BinomialTestCalculate;
import BiNGO.methods.binomial.BinomialTestCalculateUnder;
import BiNGO.methods.hypergeometric.HypergeometricTestCalculate;
import BiNGO.methods.hypergeometric.HypergeometricTestCalculateUnder;
...
public class BingoAlgorithm {
    ...
    /**
     * constant string for the SaddleSum Test
     */
    public static final String SADDLESUM = "SaddleSum test";
    /**
    ...
    public CalculateTestTask calculate_distribution() {
        ...
        } else if (params.getTest().equals(SADDLESUM)) {
            if(params.getOverOrUnder().equals(OVERSTRING)) {
                test = new SaddleSumTestCalculate(new StandardDistributionCount(params.getAnnotation(), params.getOntology(), params.getSelectedNodes(), params.getAllNodes(), params.getAlias(), params.getWeights()));
            }
